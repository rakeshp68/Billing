...
let planData = [
  ...
  },
  {
    ...
    url: "/app/upgrade",
    features: [
      "Up to 260 cash on delivery orders per month",
      "24 / 7 support (priority)",
      "Add a fee to cash on delivery",
      "Limit or hide cash on delivery based on any condition",
      "Custom cash on delivery instructions message for your Thank You page",
    ]
  },
]
